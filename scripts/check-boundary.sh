...
if grep -InE '\bVM\b|\bvm_[[:alnum:]_]*\b|\bagent_vms\b|\bvm_specs\b|\bbilling\b|\bentitlement\b|\btenant\b|\bcontrol[ -]?plane\b|\bnode[ -]?agent\b|计费|租户|套餐' $checked_files; then
